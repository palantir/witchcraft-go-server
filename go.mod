...
require (
	...
	github.com/palantir/conjure-go-runtime/v2 v2.57.0
	github.com/palantir/go-encrypted-config-value v1.22.0
	...
	github.com/palantir/witchcraft-go-logging v1.41.0
