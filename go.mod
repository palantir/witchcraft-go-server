...
require (
	...
	// https://github.com/palantir/pkg/pull/400
	github.com/palantir/pkg/refreshable/v2 v2.2.1-0.20250908224642-c7acb7461ec2
	...
	github.com/palantir/witchcraft-go-health v1.16.0
