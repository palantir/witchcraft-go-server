...
require (
	...
	github.com/palantir/conjure-go-runtime/v2 v2.44.0
	github.com/palantir/go-encrypted-config-value v1.14.0
	...
	github.com/palantir/witchcraft-go-logging v1.31.1-0.20221028172340-519ec5a0ffb2
