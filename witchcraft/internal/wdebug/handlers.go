...
// DiagnosticHandler is a type alias for wdebug.DiagnosticHandler that must exist for
// the internal godel-generate-sls-diagnostics-plugin to identify implementations of the interface.
type DiagnosticHandler = wdebug.DiagnosticHandler
